...
SECRET_KEY = 'django-insecure-*vqjb^gik*y9ibp^as8fi5=+(al2p)rztlo9q#pz&6no^fowg-'
...
# Redirect unauthenticated users to your login/signup page
LOGIN_URL = 'LogInSignUppage'
LOGIN_URL = '/accounts/'
